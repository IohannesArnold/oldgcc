...
;;- or to are the fpa registers 0-15.  (All 68000 registers and memory
;;- locations are right out).  This causes problems in gcc, which
...
(define_insn ""
  [(set (match_operand:DF 0 "push_operand" "=m")
	(match_operand:DF 1 "general_operand" "ro<>fxF"))]
  ""
  "*
{
  rtx xoperands[3];
...
(define_insn "movsi"
; Incorrect because it allows g vs g.
;  [(set (match_operand:SI 0 "general_operand" "=g,da,yg,!*x*r*m")
;	(match_operand:SI 1 "general_operand" "damKs,i,yg,*x*r*m"))]
...
(define_insn "movdi"
  [(set (match_operand:DI 0 "general_operand" "=rm,&rf,&ro<>,!&rm,!&f,y,rm,x,!x,!rm")
	(match_operand:DI 1 "general_operand" "r,m,roi<>,fF,rfF,rmi,y,rm,x"))]
